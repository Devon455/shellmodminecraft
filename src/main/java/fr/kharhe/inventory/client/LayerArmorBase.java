...
public class LayerArmorBase<T extends ModelBiped> implements LayerRenderer<EntityLivingBase>
{
    ...
    {
        ItemStack itemstack = ((EntityPlayer)entityLivingBaseIn).inventory.getStackInSlot(58);
