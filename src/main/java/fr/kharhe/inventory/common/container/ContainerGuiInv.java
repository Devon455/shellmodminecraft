package fr.kharhe.inventory.common.container;
...
public class ContainerGuiInv extends Container {
    ...
    public ContainerGuiInv(InventoryPlayer playerInventory, EntityPlayer playerIn)
    {
        ...
        MainCapability cap = MainCapability.get(player);
        MoreArmorsCapabilityModule module1 = cap.getModule(MoreArmorsCapabilityModule.class);
        for (int k = 0; k < 4; ++k){
            this.addSlotToContainer(new Slot(module1.getMoreArmorsInv(), k, 99 + k * 18, 62)
           {
                @Nullable
